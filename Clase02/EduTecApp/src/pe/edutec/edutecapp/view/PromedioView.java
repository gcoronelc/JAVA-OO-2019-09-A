...
public class PromedioView extends javax.swing.JFrame {
	...
	private void agregarPaneles(){
		jTabbedPane1.add("2 Números", new Promedio2Num());
		jTabbedPane1.add("3 Números", new Promedio3Num());
		jTabbedPane1.add("4 Números", new Promedio4Num());
		jTabbedPane1.add("5 Números", new Promedio5Num());
	}
